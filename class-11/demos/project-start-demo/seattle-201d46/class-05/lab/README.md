...
Today in lab you will fork and clone a [GitHub repo](https://github.com/codefellows/201d46-lab5), and then create solutions to some code problems such that your solutions pass the included tests.
